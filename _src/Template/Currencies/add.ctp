        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                ...
                <fieldset>
                    ...
                    <?php
                        echo $this->Form->input('id',['type'=>'select','options'=>$currencies,'class'=>'form-control','id'=>'CurrencyId']);
                        echo $this->Form->input('name',array('value'=>'UGX - Uganda Shilling','label'=>'Name eg. USD,GBP,KES','class'=>'form-control','id'=>'CurrencyName'));
