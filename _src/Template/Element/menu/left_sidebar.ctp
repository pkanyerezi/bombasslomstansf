            ...
            <li class="treeview <?=(in_array($this->request->params['controller'], ['Transactions','TransactionStatuses','TransactionTypes','CommissionStructures'])?'active':'')?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li  class="<?=(($this->request->params['controller']== 'TransactionTypes' && $this->request->params['action']=='index')?'active':'')?>">
                        <?= $this->AclHtml->link(__('Types'), ['controller' => 'TransactionTypes', 'action' => 'index']) ?>
                    </li>
                    ...
                    <li class="<?=(in_array($this->request->params['controller'], ['CommissionStructures'])?'active':'')?>">
                        <?= $this->AclHtml->link(__('CommissionStructures'), ['controller' => 'CommissionStructures', 'action' => 'index']) ?>
                    </li>
                </ul>
            </li>

            <li class="treeview <?=(in_array($this->request->params['controller'], ['Accounts','AccountTypes'])?'active':'')?>">
                <a href="#">
                    <i class="fa fa-cog"></i>
                    <span>Accounts</span>
                    <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?=(($this->request->params['controller']== 'Accounts' && $this->request->params['action']=='accountBalance')?'active':'')?>">
                        <?= $this->Html->link(__('<i class="fa fa-user"></i><span>Account Balance</span>'), ['action' => 'accountBalance','controller'=>'Accounts'],['class' => '','escape'=>false,'data-toggle'=>'tooltip']) ?>
                    </li>
                </ul>
            </li>
