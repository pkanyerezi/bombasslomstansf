            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                                ...
                                <td><?= h($commissionStructure->enabled) ?></td>
                                <td><?= $this->Html->link($commissionStructure->transaction_type_id, ['controller' => 'TransactionTypes', 'action' => 'view', $commissionStructure->transaction_type_id])  ?>
                                </td>
                                <td class="actions">
