    ...
    public function afterSave($event, $entity, $options)
    {
        ...
        if (!empty($entity->transaction_type_id)) {
            ...
            if (!empty($transactionType->commission_structure_id)) {
                // TransactionTypes
                $commission_structure = $this->TransactionTypes->CommissionStructures->get($transactionType->commission_structure_id,[
                    'fields'=>[
                ...
                $commissionTransactionData['from_branch_id'] = $entity->from_branch_id;
                $commissionTransactionData['to_branch_id'] = $entity->to_branch_id;
                $commissionTransactionData['branch_id'] = $entity->branch_id;
