        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th"></i> List Account Type'), array('action' => 'index'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
                </div>
            </div>
            <div class="box-body table-responsive">
                <?= $this->Form->create($accountType,['class'=>'form']) ?>
                <fieldset>
                    <legend><?= __('Add Account Type') ?></legend>
                    <?php
                        echo $this->Form->input('name',['class'=>'form-control']);
                        echo $this->Form->input('enabled',['class'=>'form-control',['checked'=>'checked']]);
                        echo $this->Form->input('add_to_menu',['class'=>'form-control',['checked'=>'checked']]);
                                ?>
                </fieldset>
