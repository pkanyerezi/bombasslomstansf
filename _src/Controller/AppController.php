...
{   
    ...
    public function appSettings(){
        $appSettings = $this->request->session()->read('appSettings');
        if (empty($appSettings)) {
            ...
            $this->request->session()->write('appSettings',$appSettings);
        }
    ...
    public function appTransactionStatuses(){
        $appSettings = $this->request->session()->read('appTransactionStatuses');
        if (empty($appSettings)) {
