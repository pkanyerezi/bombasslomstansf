            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                                ...
                                <td class="actions">
                            <?= $this->Html->link(__('<i class="glyphicon glyphicon-file"></i>'), ['action' => 'add', 'copy'=> $customerAccountType->id],['class' => 'btn btn-default btn-xs','escape'=>false,'data-toggle'=>'tooltip','title' => 'Copy this record']) ?>
