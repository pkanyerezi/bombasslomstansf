        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                ...
                <fieldset>
                    ...
                    <?php
                        echo $this->Form->input('show_on_receipt',['class'=>'form-control']);
                        ...
                        echo $this->Form->input('on_create_lock_to_branch_from', ['class'=>'form-control','title'=>'This makes sure that the transaction can only be initiated from the branch the money is intende to come from']);
