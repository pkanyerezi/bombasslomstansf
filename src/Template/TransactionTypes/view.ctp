        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    ...
                    <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-file"></i> Copy'), array('action' => 'add','copy'=>$transactionType->id), array('class' => 'btn btn-success', 'escape' => false)); ?>
            ...
            <div class="box-body table-responsive">
                    ...
                    <table class="table table-bordered table-striped">
                            ...
                            <td><?= $transactionType->has('linked_transaction_type') ? $this->Html->link($transactionType->linked_transaction_type->name, ['controller' => 'TransactionTypes', 'action' => 'view', $transactionType->linked_transaction_type->id]) : '' ?></td>
                        </tr>
                                                                                                                        <tr>
                            <th><?= __('Id') ?></th>
                            <td><?= $this->Number->format($transactionType->id) ?></td>
                                                                                        ...
                                                                                        <tr>
                            <th><?= __('Created') ?></th>
                            <td><?=$this->Time->format($transactionType->created,$authUser['time_format'],null,$authUser['time_zone']);?></td>
                        </tr>
                                        <tr>
                            <th><?= __('Modified') ?></th>
                            <td><?=$this->Time->format($transactionType->modified,$authUser['time_format'],null,$authUser['time_zone']);?></td>
                        </tr>
                                                                                        <tr>
