            ...
            <div class="box-body table-responsive">
                ...
                <fieldset>
                    ...
                    <?php
                        ...
                        echo $this->Form->input('require_commission_input', ['class'=>'form-control','title'=>'If checked. The cashier creating commissioned transactions will always be required to input a commission of the selected commissionType']);
