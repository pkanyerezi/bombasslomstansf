            ...
            <div class="box-body table-responsive">
                ...
                <fieldset>
                    ...
                    <?php
                        ...
                        echo $this->Form->input('customer_identity_types', ['value' => 'Passport, NationalID','class'=>'form-control']);
                        echo $this->Form->input('require_commission_input', ['class'=>'form-control','checked'=>'checked','title'=>'If checked. The cashier creating commissioned transactions will always be required to input a commission of the selected commissionType']);
                        echo $this->Form->input('final_transaction_status_id', ['class'=>'form-control']);
						echo $this->Form->input('cancel_transaction_status_id', ['class'=>'form-control']);
                        ...
                        echo $this->Form->input('max_menu_items', ['class'=>'form-control','title'=>'Total Number of Dynamic Menu items beyond which they should be collapsed']);
                    ?>
                </fieldset>
