        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <?php if($transaction->branch_id==$authUser['branch_id']):?>
            ...
            <div class="box-body table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th><?= __('Commission') ?></th>
                        <td><?= $this->Number->format($transaction->commission) ?> <?=$transaction->currency_id?></td>
                    </tr>
                    ...
                    ?>
                            <tr><th><?= __(ucwords(str_replace('_',' ',$key))) ?></th><td><?= __($value) ?></td></tr>
                    <?php 
                            endforeach;
                        endif;
                    ?>
