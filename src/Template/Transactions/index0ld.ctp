            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr style="<?=$cssStyle?>">
                        ...
                        <td class="actions">
                            <?php if ($transaction->completor_branch_id==$authUser['branch_id'] && $transaction->parent_transaction_id && $transaction->transaction_status->id!=$appSettings->final_transaction_status_id && $transaction->branch_id==$transaction->to_branch_id && $authUser['role']!='super_admin' && empty($cssStyle)): ?>
