                ...
                <center>
                    <div id="receipt-body" class="receipt-body">
                        ...
                        <table class="receipt-table">
							...
							<tr>
                                <td><?= __('CompletedBy') ?></td>
                                <th><?= $transaction->has('completed_by') ? $transaction->completed_by->name : '' ?></th>
                            </tr>
                            ...
                            <tr>
                                <td><?= __((empty($transaction->transaction_type->amount_label)?'Amount':$transaction->transaction_type->amount_label)) ?></td>
                                <th><?= $this->Number->format($transaction->value) ?> <?=$transaction->currency_id?></th>
                            </tr>

                            <?php foreach($childTransactionCollection as $childTransactions):?>
                                <?php foreach($childTransactions as $childTransaction):?>
                                    <tr>
                                        <?php if(!empty($childTransaction->transaction_type->name_on_receipt)):?>
                                            <td><?= __($childTransaction->transaction_type->name_on_receipt) ?></td>
                                        <?php else:?>
                                            <td><?= __($childTransaction->transaction_type->name) ?></td>
                                        <?php endif;?>
                                        <th><?= $this->Number->format($childTransaction->value) ?> <?=$childTransaction->currency_id?></th>
                                    </tr>
                                <?php endforeach;?>
                            <?php endforeach;?>
