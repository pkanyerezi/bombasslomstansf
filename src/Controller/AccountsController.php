...
class AccountsController extends AppController
{
    ...
    public function index()
    {
        ...
        if(!empty($_GET['branch_id'])){
            $conditions['Accounts.branch_id'] = $_GET['branch_id'];
        }
        ...
        $branches = $this->Accounts->Branches->find('list');

        $this->set(compact('accounts','branches'));
        $this->set('_serialize', ['accounts']);
    }
    ...
    {   
        ...
        if(!empty($_GET['copy'])){
            $account = $this->Accounts->get($_GET['copy']);
        }
