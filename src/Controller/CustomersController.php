...
class CustomersController extends AppController
{
    ...
    public function index()
    {
        ...
        }elseif(!in_array($this->Auth->User('role'), ['super_admin'])){
            $conditions['Customers.branch_id'] = $this->Auth->User('branch_id');
        }
        ...
        $transactionTypes = $this->TransactionTypes->find('list')->where([
            'TransactionTypes.account_type_id'=>$appSettings->customer_account_type_id,
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $customer->branch_id = $this->Auth->User('branch_id');
