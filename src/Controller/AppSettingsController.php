...
class AppSettingsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Branches', 'CustomerAccountTypes','FinalTransactionStatuses','CancelTransactionStatuses']
        ];
    ...
    public function add()
    {
		...
		$cancelTransactionStatuses = $finalTransactionStatuses;
        $this->set(compact('appSetting', 'branches', 'customerAccountTypes','finalTransactionStatuses','cancelTransactionStatuses'));
        $this->set('_serialize', ['appSetting']);
    }
