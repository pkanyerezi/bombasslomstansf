                            ...
                            <div class="box-tools">
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <li>Transactions Statement</li>
                                    <li><?= $this->Html->link(__('Created Transactions'), ['controller'=>'Transactions','action' => 'statement','created_by_id'=>$user->id]) ?></li>
                                    <li><?= $this->Html->link(__('Completed Transactions'), ['controller'=>'Transactions','action' => 'statement','completed_by_id'=>$user->id]) ?></li>
                                    <li><?= $this->Html->link(__('Modified Transactions'), ['controller'=>'Transactions','action' => 'statement','modified_by_id'=>$user->id]) ?></li>
                                    <li role="separator" class="divider"></li>

                                    <li>Transactions Balance</li>
                                    <li><?= $this->Html->link(__('Created Transactions'), ['controller'=>'Transactions','action' => 'balance','created_by_id'=>$user->id]) ?></li>
                                    <li><?= $this->Html->link(__('Completed Transactions'), ['controller'=>'Transactions','action' => 'balance','completed_by_id'=>$user->id]) ?></li>
                                    <li><?= $this->Html->link(__('Modified Transactions'), ['controller'=>'Transactions','action' => 'balance','modified_by_id'=>$user->id]) ?></li>
                                    <li role="separator" class="divider"></li>

                                    <li>Accounts</li>
                                    <li><?= $this->Html->link(__('Created Accounts Balance'), ['controller'=>'Accounts','action' => 'accountBalance','created_by_id'=>$user->id]) ?></li>
                                    <li><?= $this->Html->link(__('Completed Accounts Balance'), ['controller'=>'Accounts','action' => 'accountBalance','completed_by_id'=>$user->id]) ?></li>
                                    <li><?= $this->Html->link(__('Modified Accounts Balance'), ['controller'=>'Accounts','action' => 'accountBalance','modified_by_id'=>$user->id]) ?></li>
                                    <li role="separator" class="divider"></li>
