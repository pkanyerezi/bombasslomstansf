    ...
    <div class="col-xs-3">
        ...
        <table class="table table-bordered table-striped">
            <tr>
                <th><?= __('Name') ?></th>
                <td>
                    <a href="<?=$this->request->webroot?>customers/view/<?=$customer->id?>"><?= h($customer->name) ?></a>
                </td>
            </tr>
            <tr>
                <th><?= __('Phone') ?></th>
            ...
            <div class="box-body table-responsive">
                ...
                <fieldset>
                    ...
                    <?php
                        ...
                        echo $this->Form->input('transaction_type_id', ['options' => [$transactionType->id=>$transactionType->name],'class'=>'form-control']);
                        ...
                        if ($transactionType->reverse_operant !=3) {
                            ...
                            echo $this->Form->input('amount',[
                                ...
                                'label'=>(empty($transactionType->amount_label)?'Amount':$transactionType->amount_label)
                            ]);
                        }
