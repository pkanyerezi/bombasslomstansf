 ...
 *
 */
class TyresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'millage' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'millage' => 1,
            'created' => '2016-03-11 15:38:47',
            'modified' => '2016-03-11 15:38:47',
            'is_active' => 1
        ],
    ];
}
