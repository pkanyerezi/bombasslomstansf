...
class AppSettingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'customer_account_type_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => '2', 'comment' => 'This is the account type that identifies customers', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
