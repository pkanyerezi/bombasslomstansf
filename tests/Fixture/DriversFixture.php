...
class DriversFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contact_details' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'created' => '2016-03-01 21:50:02',
            'modified' => '2016-03-01 21:50:02'
        ],
    ];
}
