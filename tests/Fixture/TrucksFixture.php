...
class TrucksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'truck_number' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'is_owned' => 1,
            'truck_number' => 'Lorem ipsum dolor sit amet',
            'date' => '2016-03-01 21:49:49',
            'is_active' => 1
        ],
    ];
}
